...
<head>
    ...
    $(function () {       
		...
		//保存
		$("#save").click(function(){
			//如果表单中含有文件对象，就需要使用formData()对象，$("form")[0]将jQuery对象转换为DOM对象
...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        ...
        <td><input type="text" name="mid" value="${medicine.mid }"/></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">图片</td>
        <td><input type="file" name="picture" value="${medicine.picture }"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	...
        	<input type="radio" name="type" value="3" ${medicine.type==3?'checked':'' }/>西药</td>
    </tr>
    <tr>
